...
<!--    />-->
    ...
    <nav class="navbar fixed-bottom py-0 d-lg-none" >
      <div class="container pt-1 justify-content-between px-4 py-1 pt-2 " id="foot" style="margin-top: 0px !important;">
        <a :class="'nav-link d-flex flex-column justify-content-center '+(footIndex=='/'?'active':'')" href="javascript:;" @click="$router.push('/')" style="padding: 0px !important;">
          <img v-if="footIndex=='/'" class="mx-auto d-block" style="width: 26px;" :src="'./static/images/img/home1.png?t=1'">
          <img v-else class="mx-auto d-block" style="width: 26px;" :src="'./static/images/img/home1.png?t=1'">
          <span  v-if="footIndex=='/'" class="navbar-text py-0 text-zs1" style="font-size: 12px;">Home</span>
          <span v-else class="navbar-text py-0 " style="font-size: 12px;">Home</span>
        </a>
        <a :class="'nav-link d-flex flex-column justify-content-center '+(footIndex=='/contracts'?'active':'')" href="javascript:;" @click="$router.push('/contracts')" style="padding: 0px !important;">
          <img  v-if="footIndex=='/contracts'" class="mx-auto d-block" style="width: 26px;" :src="'./static/images/img/home2.png?t=1'">
          <img v-else class="mx-auto d-block" style="width: 26px;" :src="'./static/images/img/home2.png?t=1'">
          <span v-if="footIndex=='/contracts'" class="navbar-text py-0 text-zs1" style="font-size: 12px;">Contracts</span>
          <span v-else class="navbar-text py-0 " style="font-size: 12px;">Contracts</span>
        </a>
        <a :class="'nav-link d-flex flex-column justify-content-center '+(footIndex=='/dashboard'?'active':'')" href="javascript:;" @click="$router.push('/dashboard')" style="padding: 0px !important;">
          <img v-if="footIndex=='/dashboard'" class="mx-auto d-block" style="width: 26px;" :src="'./static/images/img/home4.png'">
          <img v-else class="mx-auto d-block" style="width: 26px;" :src="'./static/images/img/home4.png'">
          <span v-if="footIndex=='/dashboard'"  class="navbar-text py-0 text-zs1" style="font-size: 12px;">Dashboard</span>
          <span v-else class="navbar-text py-0 " style="font-size: 12px;">Dashboard</span>
        </a>
        <a :class="'nav-link d-flex flex-column justify-content-center '+(footIndex=='/affiliates'?'active':'')" href="javascript:;" @click="$router.push('/affiliates')" style="padding: 0px !important;">
          <img v-if="footIndex=='/affiliates'" class="mx-auto d-block" style="width: 26px;" :src="'./static/images/img/home5.png'">
          <img v-else class="mx-auto d-block" style="width: 26px;" :src="'./static/images/img/home5.png'">
          <span v-if="footIndex=='/affiliates'" class="navbar-text py-0 text-zs1" style="font-size: 12px;">Team</span>
          <span v-else class="navbar-text py-0 " style="font-size: 12px;">Team</span>
        </a>
...
<!--          <span v-if="footIndex=='/FAQ'" class="navbar-text py-0 text-zs1" style="font-size: 12px;">FAQs</span>-->
<!--          <span v-else class="navbar-text py-0 " style="font-size: 12px;">FAQs</span>-->
<!--        </a>-->
      </div>
    </nav>
  </div>
