...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    UpdateMessageInfo (state, payload) {
      state.MessageInfo = payload.data;
      localStorage['MessageInfo'] = JSON.stringify(payload.data);
    },
  ...
  actions: {
    ...
    UpdateStatisticalData: ({ commit },data) => commit('UpdateStatisticalData',{data}),
    UpdateMessageInfo: ({ commit },data) => commit('UpdateMessageInfo',{data}),
  },
  modules: {
