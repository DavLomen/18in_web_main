<template>
  <div class="HomePage">
    ...
    <div class="app-wrapper">
      <section class="about-section sp_pt_120 sp_pb_120" style="padding-top: 10rem">
        <div class="container">
            <div class="col-lg-12 ps-xl-5 p-lg-4 about-content wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.5s; animation-name: fadeInUp;">
              <h2 class="sp_site_title">{{showInfo.title}}</h2>
              <div class="fs-lg mt-3" v-html="showInfo.content"></div>
            </div>
        </div>
      </section>
    </div>
...
<script>
  export default {
    ...
    methods: {
      getListData(type){
        this.$Model.noticeList({gropid: type, page_no: 1}, data => {
