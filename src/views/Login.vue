      ...
      <div class="container" style="background: url(./static/images/1900.jpg) no-repeat;background-size: 100% 100%;">
        <div class="form-box">
          <div class="mt-9 px-4 lg:mt-[60px] lg:mr-[90px] lg:pr-0 lg:pl-10">
            <div class="form-title" style="color: #fff">{{$t('loginpage[0]')}}</div>
            <p style="color: #fff"
...
<!--                      <div class="reset-link">Forgot Password?</div>-->
                      <van-checkbox checked-color="#000" shape="square" v-model="keepUser" @change="changeKeepUser"  icon-size="14">{{$t('login.text[0]')}}</van-checkbox>
                    </div>
