          ...
          <div class="col-lg-10 ps-xl-5">
            <div class="my-order">
              <div class="user-panel-title-box">
                <h2 data-v-353dc8c4="">{{$t('header[5]')}}</h2></div>
                ...
                <div class="table-responsive">
                  <table class="table mb-0 table-s2">
                    ...
                    <tr>
                      ...
                      <th scope="col" class="text-center">{{$t('product[4]')}}</th>
                    ...
                    <tr v-for="(item,index) in listData" :key="index">
                      <td class="text-center small" style="font-size: 12px;">{{item.order_number}}<br>{{item.addtime_txt}}</td>
                      <td class="text-center small" style="font-size: 12px;">{{item.title}}</td>
                      <td class="text-center small" style="font-size: 12px;">{{InitData.currency}} {{item.day_income}}</td>
                      <td class="text-center small" style="font-size: 12px;">{{InitData.currency}} {{item.total_income}}</td>
                      <td class="text-center small" style="font-size: 12px;">{{item.cycle}} {{$t('product[15]')}}</td>
                      <td class="text-center small" style="font-size: 12px;">{{item.amount}}</td>
                      ...
                      <td class="text-center small" style="font-size: 12px;">
                        <button class="btn btn-dark" style="line-height: 14px;
    font-size: 14px;
    padding: 5px;" @click="jumpShow(item)">{{$t('product[14]')}}</button>
                      </td>
