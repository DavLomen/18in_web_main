...
<!--            <li tabindex="-1" class="el-dropdown-menu__item" style="font-weight: bold;" @click="$router.push('/dashboard/walletAddress')"><i class="el-icon-wallet"></i> {{$t('walletAddress[0]')}} </li>-->
<!--            <li tabindex="-1" class="el-dropdown-menu__item" style="font-weight: bold;" @click="$router.push('/dashboard/loginPassword')"><i class="el-icon-lock"></i> {{$t('walletAddress[1]')}} </li>-->
<!--            <li tabindex="-1" class="el-dropdown-menu__item" style="font-weight: bold;" @click="$router.push('/dashboard/payPassword')"><i class="el-icon-lock"></i> {{$t('walletAddress[2]')}} </li>-->
...
<!--        <div class="t-table">-->
<!--          <div class="tr">-->
<!--            <div class="th">{{$t('package[5]')}}</div>-->
<!--            <div class="th">{{$t('package[6]')}}</div>-->
<!--            <div class="th">{{$t('package[7]')}}</div>-->
<!--          </div>-->
<!--          <div class="no-data" v-if="listData.length==0">{{$t('vanPull[1]')}}</div>-->
<!--          <div class="tr" v-for="(item,index) in listData" :key="index">-->
<!--            <div class="td">{{item.addtime}}</div>-->
<!--            <div class="td">{{item.product}}</div>-->
        ...
        <div class="container">
          <div class="row g-3 justify-content-center">
            <div class="col-lg-10 text-center">
              <h2 class="m-0 banner-title">{{$t('package[4]')}}</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="table-responsive--md">
          <table class="table custom--table">
            ...
            <tr v-if="listData.length==0">
              <td colspan="100%">{{$t('vanPull[1]')}}</td>
            </tr>
            <tr v-for="(item,index) in listData" :key="index">
              <td :data-label="$t('package[5]')">
                {{item.addtime}}
              </td>
              <td :data-label="$t('package[6]')">
                {{item.product}}
              </td>
              <td :data-label="$t('package[7]')">
  ...
  export default {
    ...
    methods: {
      ...
      getListData(type) {
        ...
        this.$Model.getUserProductIncome({page_no:this.pageNo},data=>{
          this.isLoad = false
          if(data.code==1){
...
<style scoped>
  ...
  .el-pagination.is-background .el-pager li:not(.disabled).active {
    background-color: #ca040477!important;
