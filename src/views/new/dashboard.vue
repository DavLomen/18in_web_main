    ...
    <div class="container app-wrapper" style="width:100%;max-width: 100% !important;">
      ...
      <div id="UserNav" style="transition: .5s ease;">
        <div class="container-fluid notranslate" style="transition: .5s ease;position: relative">
          ...
          <div class="mb-20">
            <div style="display: flex; grid-gap: 20px; align-items: center; justify-content: end;">
              <a href="javascript:;" @click="$router.push('/avatar')"><div class="avatar" :style="`background-image: url('${InitData.setting.up_url+UserInfo.header}');background-position: center;`"><div class="online-user"></div></div></a>
            </div>
          </div>
        </div>
      ...
      <div class="container" style="max-width: 100% !important;">
        ...
        <div class="el-row" style="margin-left: -12px; margin-right: -12px;">
          <div class="pc box-shadow-card mb-20">
            <div class="el-col el-col-24 el-col-xs-24 el-col-sm-12 el-col-md-8" style="padding-left: 12px; padding-right: 12px;">
              <div class="cal-item text-left" style="background: #529945;color: #ffffff;">
                <div class="cal-item-header data-flex">
                  <div class="item-left flex-1 el-content-text-h1">{{ $t("i18n.Dashboard.card.text1") }}</div>
                  <div class="item-right round-box-50" style="background: #de05e6;">
                    <van-icon name="pending-payment" size="30"/>
                  </div>
                </div>
                <div class="cal-item-content mt-20">
                  <div class="data-flex mtb-10">
                    <div class="item-content-left el-content-text-h1 flex-1">{{ $t("i18n.Dashboard.card.text2") }}</div>
                    <div class="item-content-right el-content-text-h1">0$</div>
                  </div>
                  <div class="data-flex mtb-10">
                    <div class="item-content-left el-content-text-h1 flex-1">{{ $t("i18n.Dashboard.card.text3") }}</div>
                    <div class="item-content-right el-content-text-h1">0$</div>
                  </div>
                  <div class="data-flex mtb-10">
                    <div class="item-content-left el-content-text-h1 flex-1">{{ $t("i18n.Dashboard.card.text4") }}</div>
                    <div class="item-content-right el-content-text-h1">0$</div>
                  </div>
                </div>
            ...
            <div class="el-col el-col-24 el-col-xs-24 el-col-sm-12 el-col-md-8" style="padding-left: 12px; padding-right: 12px;">
              <div class="cal-item text-left" style="background: #5F33F7;color: #ffffff;">
                <div class="cal-item-header data-flex">
                  <div class="item-left flex-1 el-content-text-h1">{{ $t("i18n.Dashboard.card.text6") }}</div>
                  <div class="item-right round-box-50" style="background: #04a3cf;">
                    <van-icon name="idcard" size="30"/>
                  </div>
                </div>
                <div class="cal-item-content mt-20">
                  <div class="data-flex mtb-10">
                    <div class="item-content-left el-content-text-h1 flex-1">{{ $t("i18n.Dashboard.card.text7") }}</div>
                    <div class="item-content-right el-content-text-h1">0$</div>
                  </div>
                  <div class="data-flex mtb-10">
                    <div class="item-content-left el-content-text-h1 flex-1">{{ $t("i18n.Dashboard.card.text8") }}</div>
                    <div class="item-content-right el-content-text-h1">0$</div>
                  </div>
                  <div class="data-flex mtb-10">
                    <div class="item-content-left el-content-text-h1 flex-1">{{ $t("i18n.Dashboard.card.text9") }}</div>
                    <div class="item-content-right el-content-text-h1">0$</div>
                  </div>
                </div>
            ...
            <div class="el-col el-col-24 el-col-xs-24 el-col-sm-12 el-col-md-8" style="padding-left: 12px; padding-right: 12px;">
              <div class="cal-item text-left" style="background: #ED5C2E;color: #ffffff;">
                <div class="cal-item-header data-flex">
                  <div class="item-left flex-1 el-content-text-h1">{{ $t("i18n.Dashboard.card.text11") }}</div>
                  <div class="item-right round-box-50" style="background: #0ab33a;">
                    <van-icon name="pending-payment" size="30"/>
                  </div>
                </div>
                <div class="cal-item-content mt-20">
                  <div class="data-flex mtb-10">
                    <div class="item-content-left el-content-text-h1 flex-1">{{ $t("i18n.Dashboard.card.text12") }}</div>
                    <div class="item-content-right el-content-text-h1">0$</div>
                  </div>
                  <div class="data-flex mtb-10">
                    <div class="item-content-left el-content-text-h1 flex-1">{{ $t("i18n.Dashboard.card.text13") }}</div>
                    <div class="item-content-right el-content-text-h1">0$</div>
                  </div>
                  <div class="data-flex mtb-10">
                    <div class="item-content-left el-content-text-h1 flex-1">{{ $t("i18n.Dashboard.card.text14") }}</div>
                    <div class="item-content-right el-content-text-h1">0$</div>
                  </div>
                </div>
          ...
          <div class="pc el-row mb-20 mt-20">
            <!-- Commissions -->
              <div class="el-col-12">
                <div class="box-shadow-card mlr-5">
                  ...
                  <div class="el-row mt-20">
                    <div class="el-col-12">
                      <div class="el-black-card el-mx-auto-95">
                        <div class="flex-1 el-content-text-h2 mt-20">{{ $t("i18n.Dashboard.card.text18") }}</div>
                        <div class="flex-1 font-title mtb-10">0$</div>
                      </div>
                    </div>
                    <div class="el-col-12">
                      <div class="el-black-card el-mx-auto-95">
                        <div class="flex-1 el-content-text-h2 mt-20">{{ $t("i18n.Dashboard.card.text19") }}</div>
                        <div class="flex-1 font-title mtb-10">0$</div>
                      </div>
                    </div>
                  </div>
                  <div class="el-row mt-20">
                    <div class="el-col-24">
                      <div class="el-black-card">
                        <div class="flex-1 el-content-text-h2 mt-20">{{ $t("i18n.Dashboard.card.text20") }}</div>
                        <div class="flex-1 font-title mtb-10">0$</div>
                      </div>
                    </div>
                  </div>
