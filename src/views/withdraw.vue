          ...
          <div class="table-responsive--md">
            <table class="table custom--table">
              ...
              <tr class="border-bottom border-hhs">
                <th  class="text-center">{{$t('withdraw[9]')}}</th>
                <th class="text-center">{{$t('withdraw[6]')}}</th>
                <th  class="text-center">{{$t('walletAddress[0]')}}</th>
                <th   class="text-center">{{$t('withdraw[7]')}}</th>
                <th  class="text-center">{{$t('withdraw[8]')}}</th>
              </tr>
              </thead>
              ...
              <tr v-for="(item,index) in listData" :key="index">
                ...
                <td :data-label="$t('withdraw[6]')" >{{item.dan}}</td>
                <td :data-label="$t('walletAddress[0]')" >
                  {{item.bank_no_tail.replace(/^(.{4}).*(.{4})$/, '$1 **** $2')}}
                </td>
                <td :data-label="$t('withdraw[7]')" >{{InitData.currency}}{{item.money}}</td>
