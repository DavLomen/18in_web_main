<template>
  <div class="HomePage">
    <Header></Header>
    <div class="app-wrapper" style="overflow-x: hidden">
      <section namespace="referral_image">
        <div class="container">
          <div class="box7">
            <div class="image_main">
              <img :src="'./static/images/teacht.png'" style="object-fit:cover">
            ...
            <div class="col-md-6 col-lg-4" v-for="(item,index) in listData" :key="index">
              <div class="blog-item">
                <div class="blog-thumb">
                  <img :src="item.cover_img" alt="blog thumb" style="object-fit: contain !important;">
                </div>
  ...
  export default {
    ...
    methods: {
      ...
      getListData(type) {
        ...
        this.$Model.noticeList({gropid: 3,page_no: this.pageNo,page_size:9},data=>{
          this.isLoad = false
          if(data.code==1){
