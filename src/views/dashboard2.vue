      ...
      <div class="container col-lg-10 ">
        <div class="">
          <div class="row mx-auto align-items-center">
            <div class="col-lg-5 ">
              <div class="border rounded-4 border-0 bg-hs1 text-center p-5 single-settings-box top-flashlight light-xl leftside" style="margin-bottom: 0px !important;background: #70b7ff !important;">
                <h3 class="fw-bold">{{$t('dash[0]')}}</h3>
                <h2 class="fw-bold">{{InitData.currency}} {{UserInfo.balance}}</h2>
              </div>
            </div>
            <div class="row mx-auto col-lg-7 p-2 justify-content-center align-items-center">
              <div class="p-1 " style="width: 50%;">
                <div class="border border-0 rounded-3 py-3 px-3 d-flex align-items-center " style="background-color: #fff;">
            ...
            <div class="p-3 pt-4 row row-cols-4 ">
              <div class="text-center">
                <a href="javascript:;" @click="$router.push('/deposit')">
                  <div>
                    <img :src="'./static/images/img/da1.png'" alt="" height="60px;" class="text-center p-2 mb-2 border rounded-3 border-0">
                  </div>
                </a>
              ...
              <div class="text-center">
                <a href="javascript:;"  @click="$router.push('/withdraw')">
                  <div>
                    <img :src="'./static/images/img/da2.png'" alt="" height="60px;" class="text-center p-2 mb-2 border rounded-3 border-0" >
                  </div>
                </a>
              ...
              <div class="text-center">
                <a href="javascript:;"  @click="$router.push('/transactions')">
                  <div>
                    <img :src="'./static/images/img/da3.png'" alt="" height="60px;" class="text-center p-2 mb-2 border rounded-3 border-0" >
                  </div>
                </a>
              ...
              <div class="text-center"  @click="$router.push('/MyPackages')">
                <a href="javascript:;">
                  <div>
                    <img :src="'./static/images/img/da4.png'" alt="" height="60px;" class="text-center p-2 mb-2 border rounded-3 border-0" >
                  </div>
                </a>
          ...
          <div class="row">
            ...
            <a class="col-lg-6 col-6 p-2 text-light" href="javascript:;" @click="$router.push('/MyPackages')">
              <div class="p-3 ps-lg-5 border border-0 rounded-3  light-border" style="--x: 3.4382828898368203%;background: #fff;color: #000;">
                <div class="p-2 border border-0 rounded-3 ">
                  <div class="p-2  border border-0 rounded-3  " >
                    <img :src="'./static/images/img/da5.png'" alt="" height="60px;" class="text-center p-2 mb-2 border rounded-3 border-0" >
                  </div>
                </div>
            ...
            <a class="col-lg-6 col-6 p-2 text-light" href="javascript:;" @click="$router.push('/MyPackages')">
              <div class="p-3 ps-lg-5 border border-0 rounded-3  light-border" style="--x: 30.84027354594082%;background: #ffffff;color: #000;">
                <div class="p-2 border border-0 rounded-3 ">
                  <div class="p-2 border border-0 rounded-3  ">
                    <img :src="'./static/images/img/da6.png'" alt="" height="60px;" class="text-center p-2 mb-2 border rounded-3 border-0" >
          ...
          <div class="py-3 ">
            <div style="font-size: 1.2rem;width: 100%;">
              {{$t('account[1]')}}:<span style="font-size: 2.5rem;font-weight: bolder;color: rgb(25 137 250)">{{UserInfo.useridentity}}</span>
            </div>
            <div style="font-size: 1.2rem;width: 100%;">
              Email:<span style="font-size: 1.5rem;font-weight: bolder;color: rgb(25 137 250)">{{UserInfo.username}}</span>
            </div>
            <!-- <div class="d-flex justify-content-between m-2">
                <h6>My AffiliateLink</h6>

            </div> -->
            <div class="border rounded-3 border-0  p-3 text-center  mx-auto my-lg-5 light-border" style="--x: 24.860470433180467%;background: #fff">
              <input class="w-100 border rounded-3 border-0 ps-3 my-3" style="line-height: 20px; height: 40px; font-size: 15px; color: #323233; background-color: #1989fa61;" type="text" v-model="promoteUrl" disabled="" data-sharkid="__0">
              <button style="background: #1989fa" @click="copy" :data-clipboard-text="promoteUrl" id="copylink" class="btn btn-primary col-4 p-2 copy">{{$t('dash[11]')}}</button>
            </div>
            <div class="border rounded-3 border-0  p-3 text-center mt-3  mx-auto my-lg-5 light-border" style="--x: 35.53330553949191%;background: #fff">
              <h4 class="">{{$t('dash[12]')}}</h4>
              <span class="fs-6">{{teamNum}} </span>
