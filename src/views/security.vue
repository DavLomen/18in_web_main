  ...
  <div class="HomePage" id="app">
    ...
    <div class="app-wrapper" style="width: calc(100% - 25rem);max-width: 100%;overflow: hidden">
      <div class="page-header">
        <div class="page-title">{{$t('security[0]')}}</div>
        ...
        <div class="container-fluid">
          <div class="block-part block-sec">
            <div class="block_sec_flex">
              <div>
                <h2 class="sec_title">{{$t('security[1]')}}
                  <span style="padding-left: 1rem;font-size: 14px;">{{$t('security[2]')}}</span>
                </h2>
                <h3 class="sec_desc_1">{{$t('security[3]')}}</h3>
              </div>
      ...
      <div class="modal">
        ...
        <div class="modal-body">
          <div style="padding: 1.5rem">
            <h4 class="center purple">{{$t('security[4]')}}</h4>
            <h3 class="sec_desc_1 text-center mb-2">{{$t('security[5]')}}</h3>
...
<!--                     @keydown="changeValue(index)">-->
            ...
            <div class="centered" style="gap: 10px;">
              <button @click="submitBind" class="main-btnNew submit-b3 longbtn" style="font-size: 16px; cursor: pointer; margin-top: 15px;">{{$t('security[6]')}}</button>
              <button @click="showNotice= false" class="main-btnNew main-btnNew1 submit-b3 longbtn outlined" style="font-size: 16px; cursor: pointer; margin-top: 15px;" type="button" data-bs-dismiss="modal">{{$t('security[7]')}}</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="mask" v-show="showBind">
      <div class="modal">
        <div class="modal-header">
          <div class="modal-title">{{$t('security[8]')}}
            <br><span style="font-size: 14px;font-weight: normal;">{{$t('security[9]')}}</span>
          </div>
          <div class="close" @click="showBind = false"><i class="el-icon-close"></i></div>
        </div>
        <div class="modal-body">
          <div style="padding: 1.5rem">
            <p class="und">{{$t('security[10]')}}</p>
            <div class="centered">
...
<!--              </div>-->
            ...
            <p class="helplink"><a href="/faq">{{$t('security[12]')}}</a></p>
            <div class="centered">
              <button @click="doBind" class="main-btnNew submit-b3 longbtn" style="font-size: 24px; cursor: pointer; margin-top: 15px;">{{$t('security[13]')}}</button></div>
          </div>
        </div>
      </div>
    </div>
