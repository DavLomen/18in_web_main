                  ...
                  <div  class="overview">
                    <div class="pc1" style="width: 100%;">
                      <div class="el-row cal justify-content-center mt-5">
                        ...
                        <div class="el-col-lg-6 el-col-sm-12 el-col-xs-12 mb-1 pl-2 pr-2">
                          <div class="pc_color_card el-mx-auto-90" style="background:#17a2b8; color: #fff;">
                        ...
                        <div class="el-col-lg-6 el-col-sm-12 el-col-xs-12 mb-1 pl-2 pr-2">
                          <div class="pc_color_card el-mx-auto-90" style="background:#28a745; color: #fff;">
                    ...
                    <div class="el-row cal justify-content-center mt-1">
                      <div class="el-col-lg-8 el-col-sm-12 el-col-xs-12 mb-1 pl-2 pr-2">
                        <div class="pc_color_card el-mx-auto-90">
                    ...
                    <div class="cal">
                      ...
                      <div class="el-row justify-content-center mt-1">
                        <div class="el-col-lg-8 el-col-sm-12 el-col-xs-12 mb-1 pl-2 pr-2">
                          <div class="pc_color_card el-mx-auto-90"  @click="$router.push('/MyPackages?status=1')">
                            <div class="label fs-5 fw-bold">{{ $t('dashboard[3]') }}</div>
                            <div class="amt fs-5 fw-bold  mt-4"> {{statisticalData.activity_task}}</div>
                          </div>
                        </div>
                        <div class="el-col-lg-8 el-col-sm-12 el-col-xs-12 mb-1 pl-2 pr-2">
                          <div class="pc_color_card el-mx-auto-90" @click="$router.push('/MyPackages?status=3')">
                            <div class="label fs-5 fw-bold">{{ $t("dashboard[4]") }}</div>
                            <div class="amt fs-5 fw-bold  mt-4">{{statisticalData.expired_task }}</div>
                          </div>
                        </div>
                        <div class="el-col-lg-8 el-col-sm-24 el-col-xs-24 mb-1 pl-2 pr-2">
                          <div class="pc_color_card el-mx-auto-90" @click="$router.push('/MyPackages')">
                    ...
                    <div class="cal">
                      ...
                      <div class="el-row justify-content-center mt-1">
                        ...
                        <div class="el-col-lg-12 el-col-sm-12 el-col-xs-24 mb-1 pl-2 pr-2">
                          <div class="pc_link_input mt-2 el-mx-auto-90">
                    ...
                    <div  class="el-card box-card mt-4 mb-5 is-always-shadow show_mobile pb-5">
                        ...
                        <div  class="row">
                          <div  class="col-md-4 mt-4 pt-2"><a  href="javascript:;" @click="$router.push('/MyPackages?status=1')"
                            ...
                            <div  class="card work-process border-0 rounded shadow bg-light">
                              <div  class="card-body el-mx-auto-95"
...
<!--      </div>-->
<!--      <div class="right" style="flex:1;background: #fff;" >-->
...
<!--                </div>-->
<!--              </div>-->
<!--              &lt;!&ndash; Your Affiliate Link &ndash;&gt;-->
<!--              <div class="cal">-->
<!--                <div class="el-col-24 mb-2 pl-2 pr-2 dashboard_title">{{ $t('dashboard[10]') }}</div>-->
<!--                <div class="el-row justify-content-center mt-1">-->
<!--                  <div class="el-col-lg-12 el-col-sm-12 el-col-xs-24 mb-1 pl-2 pr-2">-->
...
<!--              &lt;!&ndash; show_mobile 在手机模式下可见 &ndash;&gt;-->
<!--              <div   class="row mb-5 show_mobile">-->
<!--                <div  class="col-md-9 mt-4">-->
<!--                  <div-->
<!--                       style="width: 100%; background-color: rgb(56, 66, 71); padding: 30px 0px; border-radius: 1.25rem;">-->
