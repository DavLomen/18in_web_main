<template>
  <div class="HomePage" id="app">
    ...
    <div class="container app-wrapper" style="width:100%;max-width: 100% !important;">
      <div class="page-header">
        <div class="page-title">{{$t('head[4]')}}</div>
        <div class="el-dropdown mobile">
<!--          <div class="lang-switch notranslate" @click="showPcLan = !showPcLan" style="width: 50px;justify-content: space-between;padding-right: 16px;padding-left: 8px; background: #F5F5F5; border: none;">-->
<!--            <div style="display: flex;align-items: center;grid-gap: 8px;">-->
<!--                  <span v-if="$i18n.locale=='en-US'">-->
<!--                <img :src="'./static/image/en-US.png'" style="width: 30px;">-->
<!--              </span>-->
<!--              <span v-if="$i18n.locale=='ko-KO'">-->
<!--                <img :src="'./static/image/ko-KO.png'" style="width: 30px;">-->
<!--              </span>-->
<!--              <span v-if="$i18n.locale=='es-ES'">-->
<!--                <img :src="'./static/image/es-ES.png'" style="width: 30px;">-->
<!--              </span>-->
<!--              <span v-if="$i18n.locale=='yd-YD'">-->
<!--                <img :src="'./static/image/yd-YD.png'" style="width: 30px;">-->
<!--              </span>-->
<!--              <span v-if="$i18n.locale=='ar-AR'">-->
<!--                <img :src="'./static/image/ar-AR.png'" style="width: 30px;">-->
<!--              </span>-->
<!--              <span v-if="$i18n.locale=='pt-PT'">-->
<!--                <img :src="'./static/image/pt-PT.png'" style="width: 30px;">-->
<!--              </span>-->
<!--              <span v-if="$i18n.locale=='ru-RU'">-->
<!--                <img :src="'./static/image/ru-RU.png'" style="width: 30px;">-->
<!--              </span>-->
<!--              <span v-if="$i18n.locale=='ja-JP'">-->
<!--                <img :src="'./static/image/ja-JP.png'" style="width: 30px;">-->
<!--              </span>-->
<!--              <span v-if="$i18n.locale=='de-DE'">-->
<!--                <img :src="'./static/image/de-DE.png'" style="width: 30px;">-->
<!--              </span>-->
<!--              <span v-if="$i18n.locale=='fr-FR'">-->
<!--                <img :src="'./static/image/fr-FR.png'" style="width: 30px;">-->
<!--              </span>-->
<!--            </div>-->
<!--            &lt;!&ndash;                <img :src="'./static/image/bottom.png'" class="arrow_lang">&ndash;&gt;-->
<!--            <div class="el-dropdown" style="position: absolute;top: 3rem;left: -4rem;">-->
<!--              <ul class="el-dropdown-menu" id="dropdown-menu-6877" v-show="showPcLan">-->
<!--                <li  @click="changeLanguage('en-US')" v-if="InitData.setting.en==1" class="el-dropdown-menu__item">&lt;!&ndash;&ndash;&gt;-->
<!--                  <div class="lang-item"><img :src="'./static/image/en-US.png'"-->
<!--                                              class="flag"> English-->
<!--                  </div>-->
<!--                </li>-->
<!--                <li @click="changeLanguage('ko-KO')" v-if="InitData.setting.ko==1" class="el-dropdown-menu__item">&lt;!&ndash;&ndash;&gt;-->
...
<!--                  </div>-->
<!--                </li>-->
<!--                &lt;!&ndash;            <li  class="el-dropdown-menu__item">&lt;!&ndash;&ndash;&gt;&ndash;&gt;-->
<!--                &lt;!&ndash;              <div class="lang-item"><img :src="'./static/images/flag7.597f635f.png'"&ndash;&gt;-->
<!--                &lt;!&ndash;                                          class="flag"> Türkçe&ndash;&gt;-->
<!--                &lt;!&ndash;              </div>&ndash;&gt;-->
<!--                &lt;!&ndash;            </li>&ndash;&gt;-->
...
<!--                  </div>-->
<!--                </li>-->
<!--                &lt;!&ndash;              <li @click="changeLanguage('ur-UR')" v-if="InitData.setting.ur==1"  class="el-dropdown-menu__item">&lt;!&ndash;&ndash;&gt;&ndash;&gt;-->
<!--                &lt;!&ndash;                <div class="lang-item"><img :src="'./static/images/flagur.png'"&ndash;&gt;-->
<!--                &lt;!&ndash;                                            class="flag"> اردو&ndash;&gt;-->
<!--                &lt;!&ndash;                </div>&ndash;&gt;-->
<!--                &lt;!&ndash;              </li>&ndash;&gt;-->
...
<!--                  </div>-->
<!--                </li>-->
<!--                <li @click="changeLanguage('pt-PT')" v-if="InitData.setting.pt==1"  class="el-dropdown-menu__item">&lt;!&ndash;&ndash;&gt;-->
<!--                  <div class="lang-item"><img :src="'./static/image/pt-PT.png'"-->
<!--                                              class="flag"> Português-->
<!--                  </div>-->
<!--                </li>-->
<!--                <li @click="changeLanguage('ru-RU')" v-if="InitData.setting.ru==1"   class="el-dropdown-menu__item">&lt;!&ndash;&ndash;&gt;-->
<!--                  <div class="lang-item"><img :src="'./static/image/ru-RU.png'"-->
<!--                                              class="flag"> Русский-->
<!--                  </div>-->
<!--                </li>-->
<!--                <li @click="changeLanguage('ja-JP')" v-if="InitData.setting.jp==1"  class="el-dropdown-menu__item">&lt;!&ndash;&ndash;&gt;-->
<!--                  <div class="lang-item"><img :src="'./static/image/ja-JP.png'"-->
<!--                                              class="flag"> 日本語-->
<!--                  </div>-->
<!--                </li>-->
<!--                <li @click="changeLanguage('de-DE')" v-if="InitData.setting.de==1"  class="el-dropdown-menu__item">&lt;!&ndash;&ndash;&gt;-->
<!--                  <div class="lang-item"><img :src="'./static/image/de-DE.png'"-->
<!--                                              class="flag"> Deutsch-->
<!--                  </div>-->
<!--                </li>-->
<!--                <li @click="changeLanguage('fr-FR')" v-if="InitData.setting.fr==1" class="el-dropdown-menu__item">&lt;!&ndash;&ndash;&gt;-->
<!--                  <div class="lang-item"><img :src="'./static/image/fr-FR.png'"-->
<!--                                              class="flag"> Français-->
<!--                  </div>-->
<!--                </li>-->
<!--                &lt;!&ndash;            <li @click="changeLanguage('zh-CN')" v-if="InitData.setting.cn==1" class="el-dropdown-menu__item">&lt;!&ndash;&ndash;&gt;&ndash;&gt;-->
<!--                &lt;!&ndash;              <div class="lang-item"><img :src="'./static/images/zh-CN.png'"&ndash;&gt;-->
<!--                &lt;!&ndash;                                          class="flag"> 中文简体&ndash;&gt;-->
<!--                &lt;!&ndash;              </div>&ndash;&gt;-->
<!--                &lt;!&ndash;            </li>&ndash;&gt;-->
<!--              </ul>-->
<!--            </div>-->
<!--          </div>-->
          <a href="javascript:;" @click="$router.push('/avatar')"><div class="avatar" :style="`background-image: url('${InitData.setting.up_url+UserInfo.header}');background-position: center;`"><div class="online-user"></div></div></a>
<!--          <div @click="showUserDown = !showUserDown" class="right-icon el-dropdown-selfdefine" aria-haspopup="list" aria-controls="dropdown-menu-8265" role="button" tabindex="0" x-placement="bottom-end"><i class="el-icon-user"></i></div>-->
      ...
      <div id="UserNav" style="transition: .5s ease;">
        <div class="container-fluid notranslate" style="transition: .5s ease;position: relative">

          <div class="navbar-d glk" style="margin-top: 59px;">
            <div class="nav-men">
              <div class="nav-els">
                <a href="javascript:;" @click="$router.push('/')" class="a"><div class="d-nav-item" name2="Home">{{$t('head[0]')}}</div><div class="underlined"></div></a>
                <a href="javascript:;" @click="$router.push('/product')" class="a"><div class="d-nav-item" name2="Plans">{{$t('foot[2]')}}</div><div class="underlined"></div></a>
                <a href="javascript:;" @click="$router.push('/about')" class="a"><div class="d-nav-item">{{$t('foot[3]')}}</div><div class="underlined"></div></a>
                <a href="javascript:;" @click="$router.push('/affiliates')"  class="a"><div class="d-nav-item" name2="Referral">{{$t('about[0]')}} {{$t('foot[5]')}}</div><div class="underlined"></div></a>
                <a href="javascript:;" @click="$router.push('/Bounty')" class="a"><div class="d-nav-item" name2="About Us">{{$t('bounty')}}</div><div class="underlined"></div></a>
                <a href="javascript:;" @click="$router.push('/FAQ')" class="a"><div class="d-nav-item" name2="FAQ">{{$t('foot[4]')}}</div><div class="underlined"></div></a>
                <a href="javascript:;" @click="$router.push('/welfare')" class="a"><div class="d-nav-item" name2="APP">{{$t('welfare[0]')}}</div><div class="underlined"></div></a>
                <a href="javascript:;" @click="$router.push('/app')" class="a"><div class="d-nav-item" name2="APP">{{$t('head[1]')}}</div><div class="underlined"></div></a>
                <a href="javascript:;" @click="$router.push('/teach')" class="a"><div class="d-nav-item" name2="APP">{{$t('teach[0]')}}</div><div class="underlined"></div></a>
              </div>
            </div>
...
<!--                </div>-->
<!--&lt;!&ndash;                <img :src="'./static/image/bottom.png'" class="arrow_lang">&ndash;&gt;-->
<!--                <div class="el-dropdown pc" style="position: absolute;top: 3rem;left: 0;">-->
<!--                  <ul class="el-dropdown-menu" id="dropdown-menu-6877" v-show="showPcLan">-->
<!--                    <li  @click="changeLanguage('en-US')" v-if="InitData.setting.en==1" class="el-dropdown-menu__item">&lt;!&ndash;&ndash;&gt;-->
<!--                      <div class="lang-item"><img :src="'./static/image/en-US.png'"-->
<!--                                                  class="flag"> English-->
        ...
        <div class="mobile">
          <div class="flex-3">
            ...
            <div class="item-m" @click="$router.push('/withdraw')">
              <div>
                <div class="bg" style="background-color: #5F33F7;"><img :src="'./static/image/arrow_upward.svg'"></div>
                <div class="div">{{$t('head[8]')}}</div>
              </div>
            </div>
           <div class="item-m"  @click="$router.push('/MyPackages')">
            <div>
              <div class="bg" style="background-color: #ED5C2E;"><img :src="'./static/image/receipt_long.svg'"></div>
              <div class="div">{{$t('head[11]')}}</div>
            </div>
            </div>
            <div class="item-m" @click="$router.push('/transactions')">
             <div>
               <div class="bg" style="background-color: #FF971E;"><img :src="'./static/image/inventory_2.svg'"></div>
...
<style scoped>
  ...
  .bal-bg {
    ...
    height: 175px;
    border-radius: 10px;
    background: linear-gradient(180deg, #76ff81 0%, #10732f 100%);
    left: 0;
  }
  .bal-c{
    position: absolute;
  ...
  .d-nav-item:hover + .underlined {
    width: 70.2%;
    opacity: 1;
  }


  .naved-active + .underlined {
    width: 70.2%;
    opacity: 1;
  }
