      ...
      <section class="sp_pt_40 sp_pb_40 mt-200 std">
        ...
        <div class="container mt-120 mb-120 cont_std std_2">
          ...
          <div class="grids mt-60">
            <div class="bt_block">
              <img :src="'./static/img/app1.png?t=5'" class="bt_round">
              <div class="bt_desc">
                <h3>{{$t('appDown[3]')}}</h3>
                <p>{{$t('appDown[4]')}}</p>
              </div>
            ...
            <div class="bt_block">
            <img :src="'./static/img/app2.png?t=5'" class="bt_round">
            <div class="bt_desc">
                <h3>{{$t('appDown[5]')}}</h3>
                <p>{{$t('appDown[6]')}}</p>
              </div>
            ...
            <div class="bt_block">
              <img :src="'./static/img/app3.png?t=5'" class="bt_round">
              <div class="bt_desc">
                <h3>{{$t('appDown[7]')}}</h3>
                <p>{{$t('appDown[8]')}}</p>
              </div>
            ...
            <div class="bt_block">
              <img :src="'./static/img/app4.png?t=5'" class="bt_round">
              <div class="bt_desc">
                <h3>{{$t('appDown[9]')}}</h3>
                <p>{{$t('appDown[10]')}}</p>
              </div>
