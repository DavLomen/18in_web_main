    ...
    <div class="app-wrapper">
      <div class="mobilec" style="background: linear-gradient(90deg, #8a348e 0%, #423f88 100%);">
        <div class="container cont_std">
          <div class="ajax-content-wrap">
            <div class="container-wrap">
              <div class="container main-content">
                <div class="row">
                  <div id="download" data-column-margin="default" data-midnight="light"
                       class="wpb_row vc_row-fluid vc_row full-width-section vc_row-o-equal-height vc_row-flex vc_row-o-content-middle right_padding_15pct left_padding_15pct right_padding_phone_2pct left_padding_phone_2pct nitro-offscreen"
                    ...
                    <div class="row-bg-wrap" data-bg-animation="none" data-bg-animation-delay="" data-bg-overlay="true">
                      <div class="inner-wrap row-bg-layer using-image">
                        <div
                          style="background-image: url('data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw=='), url('https://cdn-ilcbnhb.nitrocdn.com/eyWebYtfntWmnihDSZRZvIqipddxdlOp/assets/images/optimized/rev-858f96d/minepi.com/wp-content/uploads/2022/06/236.jpg'); background-position: left top; background-repeat: no-repeat; background-color: rgb(66, 63, 136);"
                          class="row-bg viewport-desktop using-image using-bg-color lazyloaded"
                        ></div>
                      </div>
                      <div class="row-bg-overlay row-bg-layer"
                           style="background:#8a348e;background:linear-gradient(90deg,#8a348e 0%,#423f88 100%);opacity:1;"></div>
                    </div>
                      ...
                      <div
                        ...
                        <div class="vc_column-inner">
                          <div class="wpb_wrapper"><h2 style="font-size:35px;color:#f4af47;text-align:left;"
                                                       class="vc_custom_heading vc_do_custom_heading wpb_animate_when_almost_visible wpb_left-to-right left-to-right vc_custom_1669860888911 animated wpb_start_animation">
                            {{$t('download1[0]')}}</h2>
                            <div class="wpb_text_column wpb_content_element  vc_custom_1670287271559">
                              <div class="wpb_wrapper"><h5><span style="font-weight:400;">
                                {{$t('download1[1]')}}
                              </span>
                              </h5></div>
                            </div>
                            <div id="fws_67c1fd210e31e" data-midnight="" data-column-margin="default"
                                        ...
                                        <div class="inner">
                                          <div class="hover-wrap" style="opacity: 1;">
                                            <div class="hover-wrap-inner"><a
                                              @click="downloadApp('andriod')" href="javascript:;" class=""> <img data-delay="0" height="167" width="566"
                                                                             data-animation="fade-in" alt=""
                                                                             sizes="(max-width: 566px) 100vw, 566px"
                                                                             class="img-with-animation google_play_button lazyloaded animated-in"
                                    ...
                                    <div class="wpb_wrapper">
                                      <div class="img-with-aniamtion-wrap " data-max-width="100%"
                                        ...
                                        <div class="inner">
                                          <div class="hover-wrap" style="opacity: 1;">
                                            <div class="hover-wrap-inner"><a
                                              @click="downloadApp('ios')" href="javascript:;"
                                              class=""> <img data-delay="0" height="167" width="563" data-animation="fade-in"
                                                             alt="" sizes="(max-width: 563px) 100vw, 563px"
                                                             class="img-with-animation apple_store_button lazyloaded animated-in"
                                                             decoding="async" nitro-lazy-empty="" id="NzcyOjQyNQ==-1"
                                                             :src="'./static/images/apple_store.png'"
                                                             >
                                            </a></div>
                                          </div>
                                        </div>
          ...
          <!--                    <img :src="'./static/images/download/android.png'"></a>-->
          <!--                  <a @click="downloadApp('ios')" id="downloadappIos" target="blank_" class="mt-10 block">-->
          <!--                    <img :src="'./static/images/download/iphone.png'"></a>-->
          <!--                </div>-->
          <!--                &lt;!&ndash;                <div class="qr_code_down"><img :src="'./static/images/download/qrcode.png?t=7'"></div>&ndash;&gt;-->
          <!--              </div>-->
          <!--            </div>-->
          <!--            <div class="">-->
          <!--              <img :src="'./static/images/app.png'">-->
          <!--              &lt;!&ndash;              <div>&ndash;&gt;-->
          <!--              &lt;!&ndash;                <img :src="'./static/images/download/app1.png?t=6'">&ndash;&gt;-->
          <!--              &lt;!&ndash;                <img :src="'./static/images/download/app2.png?t=6'">&ndash;&gt;-->
          <!--              &lt;!&ndash;              </div>&ndash;&gt;-->
          <!--            </div>-->
          <!--          </div>-->
        </div>
      ...
      <section class="sp_pt_40 sp_pb_40 mt-200 std">
        ...
        <div class="container mt-120 mb-120 cont_std std_2">
          ...
          <div class="grids mt-60">
            <div class="bt_block">
              <img :src="'./static/images/app1.png?t=2'" class="bt_round">
              <div class="bt_desc">
                <h3>{{$t('appDown[3]')}}</h3>
                <p>{{$t('appDown[4]')}}</p>
              </div>
            ...
            <div class="bt_block">
              <img :src="'./static/images/app2.png?t=2'" class="bt_round">
              <div class="bt_desc">
                <h3>{{$t('appDown[5]')}}</h3>
                <p>{{$t('appDown[6]')}}</p>
              </div>
            ...
            <div class="bt_block">
              <img :src="'./static/images/app3.png?t=2'" class="bt_round">
              <div class="bt_desc">
                <h3>{{$t('appDown[7]')}}</h3>
                <p>{{$t('appDown[8]')}}</p>
              </div>
            ...
            <div class="bt_block">
              <img :src="'./static/images/app4.png?t=2'" class="bt_round">
              <div class="bt_desc">
                <h3>{{$t('appDown[9]')}}</h3>
                <p>{{$t('appDown[10]')}}</p>
              </div>
...
<style scoped>
  ...
  */
  ...
  .qr_code_down {
    ...
    border-radius: 5px;
    padding: 6px;
    box-shadow: 0px 16.25px 32.5px rgba(0, 0, 0, 0.1);
    cursor: pointer;
  }
  ...
  .bt_round {
    ...
    height: 72px;
    border-radius: 10px;
    /*background: linear-gradient(135deg,rgba(247,107,28,.1) 2.88%,rgba(251,218,97,.1) 98.13%);*/
    display: flex;
    align-items: center;
    justify-content: center;
  }
  ...
  * {
  ...
  .default-skin-loading-icon {
    ...
    display: block;
    background-repeat: no-repeat;
    background-image: url("https://cdn-ilcbnhb.nitrocdn.com/eyWebYtfntWmnihDSZRZvIqipddxdlOp/assets/images/optimized/rev-858f96d/minepi.com/wp-content/themes/salient/img/icons/loading-white-bg.gif");
  }
  ...
  #header-outer .sf-menu li ul li.menu-item a .item_desc,#slide-out-widget-area .inner .off-canvas-menu-container li a .item_desc {
    display: block;
    font-size: 14px;
    line-height: 22px;
  }
  ...
  #footer-outer .social i,#header-outer #social-in-menu i,.off-canvas-social-links li i {
    display: inline-block;
    text-align: center;
    vertical-align: middle;
  }
  ...
  #header-outer[data-lhe=animated_underline] #top nav>ul>#social-in-menu>a,#header-outer[data-lhe=button_bg] #top nav>ul>#social-in-menu>a,#header-outer[data-lhe=default] #top nav>ul>#social-in-menu>a,#header-outer[data-lhe=text_reveal] #top nav>ul>#social-in-menu>a {
    margin-left: 0;
    margin-right: 0;
    padding-right: 0;
    padding-left: 0;
  ...
  * html .slides {
  ...
  .nectar-underline .post-heading,.nectar-underline h1,.nectar-underline h2,.nectar-underline h3,.nectar-underline h4,.nectar-underline h5 {
    display: inline;
  }

  .nectar-category-grid[data-style=mouse_follow_image][data-text-color=light]:not([data-text-hover-color=dark]) .nectar-category-grid-item .cat-heading,.nectar-category-grid[data-style=mouse_follow_image][data-text-hover-color=light] .nectar-category-grid-item .cat-heading,.nectar-post-grid[data-text-color=light] .nectar-underline .post-heading,.span_12.light .nectar-link-underline-effect a,.span_12.light .nectar-underline .post-heading,.span_12.light .nectar-underline h1,.span_12.light .nectar-underline h2,.span_12.light .nectar-underline h3,.span_12.light .nectar-underline h4,.span_12.light .nectar-underline h5 {
  ...
  .post.quote .post-content .quote-inner .icon {
    ...
    width: 19px;
    display: block;
    background-image: url("https://cdn-ilcbnhb.nitrocdn.com/eyWebYtfntWmnihDSZRZvIqipddxdlOp/assets/images/optimized/rev-858f96d/minepi.com/wp-content/themes/salient/img/icons/quote.png");
    position: absolute;
    right: 20px;
  }
  ...
  .post.link .post-content .link-inner .icon {
    ...
    width: 18px;
    display: block;
    background-image: url("https://cdn-ilcbnhb.nitrocdn.com/eyWebYtfntWmnihDSZRZvIqipddxdlOp/assets/images/optimized/rev-858f96d/minepi.com/wp-content/themes/salient/img/icons/link.png");
    position: absolute;
    right: 20px;
  }
  ...
  .post.format-status .post-content .status-inner .icon {
    ...
    width: 18px;
    display: block;
    background-image: url("https://cdn-ilcbnhb.nitrocdn.com/eyWebYtfntWmnihDSZRZvIqipddxdlOp/assets/images/optimized/rev-858f96d/minepi.com/wp-content/themes/salient/img/icons/status.png");
    position: absolute;
    right: 20px;
  }
  ...
  @media only screen and (-o-min-device-pixel-ratio: 3/2),only screen and (-webkit-min-device-pixel-ratio:1.5),only screen and (min-device-pixel-ratio:1.5),only screen and (min-resolution:144dpi) {
    body .post.quote .post-content .quote-inner .icon {
      ...
      background-image: url("https://cdn-ilcbnhb.nitrocdn.com/eyWebYtfntWmnihDSZRZvIqipddxdlOp/assets/images/optimized/rev-858f96d/minepi.com/wp-content/themes/salient/img/icons/quote-2x.png");
    }

    body .post.link .post-content .link-inner .icon {
      background-size: 18px 20px;
      background-image: url("https://cdn-ilcbnhb.nitrocdn.com/eyWebYtfntWmnihDSZRZvIqipddxdlOp/assets/images/optimized/rev-858f96d/minepi.com/wp-content/themes/salient/img/icons/link-2x.png");
    }
  ...
  #pagination .next a,#pagination .next.inactive,#pagination .page-numbers.next,.woocommerce nav.woocommerce-pagination ul li .page-numbers.next {
    background-image: url("https://cdn-ilcbnhb.nitrocdn.com/eyWebYtfntWmnihDSZRZvIqipddxdlOp/assets/images/optimized/rev-858f96d/minepi.com/wp-content/themes/salient/img/icons/portfolio-arrows.png");
  ...
  @media only screen and (-o-min-device-pixel-ratio: 3/2),only screen and (-webkit-min-device-pixel-ratio:1.5),only screen and (min-device-pixel-ratio:1.5),only screen and (min-resolution:144dpi) {
    #pagination .next a,#pagination .next.inactive,#pagination .page-numbers.next,.woocommerce nav.woocommerce-pagination ul li .page-numbers.next {
      background-image:url("https://cdn-ilcbnhb.nitrocdn.com/eyWebYtfntWmnihDSZRZvIqipddxdlOp/assets/images/optimized/rev-858f96d/minepi.com/wp-content/themes/salient/img/icons/portfolio-arrows-2x.png");
  ...
  body:not(.material) .comment-list .children {
    ...
    background-image: url("https://cdn-ilcbnhb.nitrocdn.com/eyWebYtfntWmnihDSZRZvIqipddxdlOp/assets/images/optimized/rev-858f96d/minepi.com/wp-content/themes/salient/img/icons/comment-children-line.jpg");
  }
  ...
  @media only screen and (max-width: 690px) {
  body .vc_row.left_padding_phone_2pct .row_col_wrap_12 {
    padding-left: 2% !important;
  }
  }
  @media only screen and (max-width: 690px) {
  body .vc_row.right_padding_phone_2pct .row_col_wrap_12 {
