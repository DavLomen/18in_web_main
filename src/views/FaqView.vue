				...
				<div data-v-430b017a="" data-v-6b500d1a="" class="HomePage">
					...
					<div data-v-47f700e2="" class="app-wrapper">
						<div data-v-47f700e2="" class="container">
							...
							<div data-v-47f700e2="" class="box7" style="padding: 50px 0 ;">
								<div style="display: flex;justify-content: center;">
									<img src="@/static/images/faqs.jpg" style="width: 100%;"/>
								</div>
								<div data-v-47f700e2="" class="box-wrapper" style="padding: 50px 0 ;">
									<!-- <div data-v-47f700e2="" class="title">{{$t("faq.CommonProblem")}}</div> -->

									<div data-v-47f700e2="" class="faq-list">
										<div data-v-47f700e2="" class="faq-item" style="padding: 10px 20px;" v-for="(item,index) in list"
											:key="index">
											<div data-v-47f700e2="" class="faq-title" @click="clickShow(item,index)">
												...
												<div data-v-47f700e2="" class="right-icon">
													...
													<i v-show="!item.show" class="el-icon-plus" style="font-size: 30px;"></i>
													<i v-show="item.show" class="el-icon-minus" style="font-size: 30px;"></i>
