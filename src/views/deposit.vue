    ...
    <div class="app-wrapper" style="width: calc(100% - 25rem);">
      ...
      <div v-if="showPrice && siteBank.length>0" class="container">
        <div class="box" style="position: relative;">
          ...
          <div class="title">
            {{$t('deposit[0]')}} <span style="color: #722283">{{InitData.currency}}{{postData.money}}</span>,
            {{$t('deposit[1]')}}
...
<!--                <input disabled="disabled" v-model=""  />-->
                <div class="disabled-input" style="    word-wrap: break-word;
    height: auto;
...
<!--        </div>-->
        ...
        <div class="main user-box" style="background: #f8f9fc">
    ...
    width: 100%;">
              ...
              <div class="form">
                <div  class="item" style="margin-top: 1.25rem;">
                  <div  class="item-label">{{$t('deposit[9]')}}</div>
              ...
              <div style="font-size: 1.5rem;color: #e73329;margin-bottom: 10px;">{{$t('tips[2]')}}</div>
              <div class="submit-btn" @click="selectType()">{{$t('deposit[13]')}}</div>
            </div>
          </form>
          <div class="info-list">
            <div class="info-item">
...
<!--            </div>-->
              ...
              <table class="table custom--table">
                ...
                <tr v-for="(item,index) in listData" :key="index">
                  ...
                  <td :data-label="$t('deposit[19]')">
                    <div class="detail-btn" @click="showD(item)"><i style="font-size: 1.5rem" class="el-icon-monitor"></i></div>
                  </td>
                </tr>
                </tbody>
              </table>
        ...
        <div id="approveModal" v-if="showDetail" class="modal custom--modal fade show" tabindex="-1" style="background: rgba(0, 0, 0, 0.7);display: block; padding-left: 0px;font-size: 1.5rem" aria-modal="true" role="dialog">
...
<!--                  <br>-->
<!--                  <strong class="my-3">{{$t('deposit[27]')}}</strong>  -->
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-dark" @click="showDetail = false" data-bs-dismiss="modal">{{$t('confirm')}}</button>
              </div>
            </div>
          </div>
        </div>
