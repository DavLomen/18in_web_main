<template>
  <div class="header">
    <div class="header-wrapper">
      <img :src="'./static/image/dashboard.png'"
                                     class="logo">
      <div class="nav-list">
        ...
        <div :class="'nav-item '+(index==9?'active':'')" style="color: rgb(13,110,253);" @click="$router.push('/Bounty')"> {{$t('bounty')}}<div class="underlined"></div></div>
        <div :class="'nav-item '+(index==4?'active':'')" @click="$router.push('/affiliate')"> {{$t('foot[5]')}}<div class="underlined"></div></div>
        <div :class="'nav-item '+(index==5?'active':'')" @click="$router.push('/teach')"> {{$t('teach[0]')}}<div class="underlined"></div></div>
...
<!--            </li>-->
      ...
      <div v-if="showMask" class="nav-mask">
        <div class="nav-list">
          ...
          <div :class="'nav-item '+(index==9?'active':'')" style="color: rgb(13,110,253);" @click="$router.push('/Bounty')"> {{$t('bounty')}}</div>
...
<style scoped>
  ...
  .dasbtn {
    background: linear-gradient(180deg, #4a9bd4 0%, #1e45d4 100%) !important;
  }
  @media only screen and (min-width: 1024px) {
    .header .header-wrapper .nav-list .action-box {
      display: flex;
